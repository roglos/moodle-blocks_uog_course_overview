...
/**
 * uog_course_overview block settings
 *
...
if ($ADMIN->fulltree) {
    $settings->add(new admin_setting_configtext('block_uog_course_overview/defaultmaxcourses', new lang_string('defaultmaxcourses', 'block_uog_course_overview'),
        new lang_string('defaultmaxcoursesdesc', 'block_uog_course_overview'), 10, PARAM_INT));
    $settings->add(new admin_setting_configcheckbox('block_uog_course_overview/forcedefaultmaxcourses', new lang_string('forcedefaultmaxcourses', 'block_uog_course_overview'),
        new lang_string('forcedefaultmaxcoursesdesc', 'block_uog_course_overview'), 1, PARAM_INT));
    $settings->add(new admin_setting_configcheckbox('block_uog_course_overview/showchildren', new lang_string('showchildren', 'block_uog_course_overview'),
        new lang_string('showchildrendesc', 'block_uog_course_overview'), 1, PARAM_INT));
