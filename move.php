...
/**
 * Move/order course functionality for uog_course_overview block.
 *
...
list($courses, $sitecourses, $coursecount) = block_uog_course_overview_get_sorted_courses();
...
block_uog_course_overview_update_myorder(array_values($neworder));
redirect(new moodle_url('/my/index.php'));
