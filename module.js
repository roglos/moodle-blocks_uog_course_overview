M.block_uog_course_overview = {}

M.block_uog_course_overview.add_handles = function(Y) {
    M.block_uog_course_overview.Y = Y;
    var MOVEICON = {
        pix: "i/move_2d",
        component: 'moodle'
    };
    ...
    YUI().use('dd-constrain', 'dd-proxy', 'dd-drop', 'dd-plugin', function(Y) {
        ...
        Y.DD.DDM.on('drag:start', function(e) {
            ...
            drag.get('dragNode').addClass('block_uog_course_overview');
        ...
        Y.DD.DDM.on('drag:end', function(e) {
            ...
            M.block_uog_course_overview.save(Y);
        });
...
M.block_uog_course_overview.save = function() {
    var Y = M.block_uog_course_overview.Y;
    ...
    Y.io(M.cfg.wwwroot+'/blocks/uog_course_overview/save.php', {
        method: 'POST',
 ...
 */
M.block_uog_course_overview.collapsible = function(Y, id, userpref, strtooltip) {
    if (userpref) {
        M.block_uog_course_overview.userpref = true;
    }
    Y.use('anim', function(Y) {
        new M.block_uog_course_overview.CollapsibleRegion(Y, id, userpref, strtooltip);
    });
};
 ...
 * @param {String} strtooltip
 */
M.block_uog_course_overview.CollapsibleRegion = function(Y, id, userpref, strtooltip) {
...
M.block_uog_course_overview.userpref = false;
 ...
 * @type String
 */
M.block_uog_course_overview.CollapsibleRegion.prototype.userpref = null;
 ...
 * @type Y.Node
 */
M.block_uog_course_overview.CollapsibleRegion.prototype.div = null;
 ...
 * @type Y.Node
 */
M.block_uog_course_overview.CollapsibleRegion.prototype.icon = null;
